...
| Release          | 音碼方案 | 形碼方案 | 簡繁   | 單字數量  | 備考              |
| ---------------- | ---- | ---- | ---- | ----- | --------------- |
| `molong-chs`     | 自然龍  | 自然龍  | 主簡可繁 | 4.7萬+ |                 |
| `molong-cht`     | 自然龍  | 自然龍  | 主繁可簡 | 4.7萬+ |                 |
| `zrloopkai-chs`  | 環形自然 | 魔然   | 主簡可繁 | 4.9萬+ |                 |
| `zrloopkai-cht`  | 環形自然 | 魔然   | 主繁可簡 | 4.9萬+ |                 |
| `xhloopkai-chs`  | 環形鶴  | 魔然   | 主簡可繁 | 4.9萬+ |                 |
| `xhloopkai-cht`  | 環形鶴  | 魔然   | 主繁可簡 | 4.9萬+ |                 |
| `xhloopfly-chs`  | 環形鶴  | 小鶴雙形 | 主簡可繁 |       | 企劃中，小字庫，受限於小鶴雙形 |
| `xhloopfly-cht`  | 環形鶴  | 小鶴雙形 | 主繁可簡 |       | 企劃中，小字庫，受限於小鶴雙形 |
| `zrloopmoqi-chs` | 環形自然 | 墨奇碼  | 主簡可繁 |       | 企劃中             |
| `zrloopmoqi-cht` | 環形自然 | 墨奇碼  | 主繁可簡 |       | 企劃中             |
| `xhloopmoqi-chs` | 環形鶴  | 墨奇碼  | 主簡可繁 |       | 企劃中             |
| `xhloopmoqi-cht` | 環形鶴  | 墨奇碼  | 主繁可簡 |       | 企劃中             |
...
- 拆字反查：用 ``ocz`` 引導（注：各方案使用各自對應的帶調雙拼）
