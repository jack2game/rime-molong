...
| 發行版          | 音碼方案 | 形碼方案 | 形碼數    | 總單字數   | 備考         |
| ------------ | ---- | ---- | ------ | ------ | ---------- |
| `molong`     | 自然龍  | 自然龍  | 4.7萬+  | 4.9萬+  | 大竹查詢：`魔龙`  |
| `molongkai`  | 自然龍  | 魔然   | 4.9萬+  | 4.9萬+  |            |
| `xhloopfly`  | 環形鶴  | 小鶴雙形 | <1萬    | 4.9萬+  |            |
| `xhloopkai`  | 環形鶴  | 魔然   | 4.9萬+  | 4.9萬+  | 大竹查詢：`环形鹤` |
| `xhloopmoqi` | 環形鶴  | 墨奇碼  | <1萬    | 4.9萬+  |            |
| `zrloopkai`  | 環形自然 | 魔然   | 4.9萬+  | 4.9萬+  |            |
| `xhupkai`    | 小鶴雙拼 | 魔然   | 11.7萬+ | 11.7萬+ |            |
| `xhupmoqi`   | 小鶴雙拼 | 墨奇碼  | <1萬    | 11.7萬+ |            |
| `xhupzrmfast`   | 小鶴雙拼 | 自然快手 | <1萬    | 11.7萬+ |            |
