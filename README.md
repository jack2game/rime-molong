...
| `xhloopfly`  | 環形鶴  | 小鶴雙形 | <1萬  |                |
| `xhloopkai`  | 環形鶴  | 魔然   | 4.9萬+ | 大竹查詢：`环形鹤`  |
| `xhloopmoqi` | 環形鶴  | 墨奇碼  | <1萬  |                |
| `zrloopkai`  | 環形自然 | 魔然   | 4.9萬+ |             |
| `xhupkai`  | 小鶴雙拼 | 魔然   | 11.7萬+ |             |
| `xhupmoqi`  | 小鶴雙拼 | 墨奇碼 | <1萬  |             |
...
![comparison](https://github.com/jack2game/rime-molong/assets/16070158/169a65b1-9f6c-42e5-b78e-7963048b7f91)
