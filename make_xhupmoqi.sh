...
sed -i '0,/\.\.\./d' ../xhupmoqi-cht/temp.txt  #perl -CSAD -i -pe "s/.\t[a-z]{2};;(\t[0-9]+)?\n//g" ../xhupmoqi-cht/temp.txt && sed -i '0,/\.\.\./d' ../xhupmoqi-cht/temp.txt
...
sed -i '0,/\.\.\./d' ../xhupmoqi-chs/temp.txt  #perl -CSAD -i -pe "s/.\t[a-z]{2};;(\t[0-9]+)?\n//g" ../xhupmoqi-chs/temp.txt && sed -i '0,/\.\.\./d' ../xhupmoqi-chs/temp.txt
...
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/8105.dict.yaml    -x moqidb -t -o ../xhupmoqi-cht/ice-dicts/xhupmoqi_moqidb_8105.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/41448.dict.yaml   -x moqidb -t -o ../xhupmoqi-cht/ice-dicts/xhupmoqi_moqidb_41448.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/base.dict.yaml    -x moqidb -t -o ../xhupmoqi-cht/ice-dicts/xhupmoqi_moqidb_base.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/ext.dict.yaml     -x moqidb -t -o ../xhupmoqi-cht/ice-dicts/xhupmoqi_moqidb_ext.dict.yaml
...
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/tencent.dict.yaml -x moqidb -t -o ../xhupmoqi-cht/ice-dicts/xhupmoqi_moqidb_tencent.dict.yaml
# 生成簡體霧凇
...
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/8105.dict.yaml    -x moqidb -o ../xhupmoqi-chs/ice-dicts/xhupmoqi_moqidb_8105.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/41448.dict.yaml   -x moqidb -o ../xhupmoqi-chs/ice-dicts/xhupmoqi_moqidb_41448.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/base.dict.yaml    -x moqidb -o ../xhupmoqi-chs/ice-dicts/xhupmoqi_moqidb_base.dict.yaml
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/ext.dict.yaml     -x moqidb -o ../xhupmoqi-chs/ice-dicts/xhupmoqi_moqidb_ext.dict.yaml
...
# python3 gen_dict_with_shape.py -i ../rime-ice/cn_dicts/tencent.dict.yaml -x moqidb -o ../xhupmoqi-chs/ice-dicts/xhupmoqi_moqidb_tencent.dict.yaml
cd ..
